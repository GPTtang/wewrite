...
## 女性受众 target_audience 加成

如果 `target_audience` 明确包含"女性"（如"城市女性"、"职场女性"、"25-35岁女性"等），对以下类型选题追加相关度加成：

| 选题特征 | 加分条件 | 加分 |
|---------|---------|------|
| 情感共鸣 | 选题涉及情感关系、自我和解、成长困境 | +2 |
| 职场女性 | 选题涉及女性职场、晋升、平衡家庭与事业 | +2 |
| 生活方式 | 选题涉及穿搭/美妆/健康/自律/生活品质 | +1 |
| 她经济 | 选题涉及消费决策、独立女性、女性财商 | +1 |

此加成作用于相关度分，与 content_style 加成独立叠加，最终相关度分上限为 10 分。
