...
name: wewrite
description: |
  微信公众号情感类内容全流程助手：热点抓取 → 选题 → 框架 → 内容增强 → 写作 → SEO → 视觉AI → 排版推送草稿箱。
...
生成 **10 个选题**，其中：
- **7-8 个热点选题**：基于 2.1 的热点，按 topic-selection.md 规则评分（情感类账号启用情感相关度加成）
- **2-3 个常青选题**：不依赖热点，从用户的 `topics` 领域生成长尾内容（情感类：关系洞察/自我成长/情绪管理经验；干货类：教程/方法论/经验总结/工具推荐），标注为"常青"
...
8 套框架（痛点/故事/清单/对比/热点解读/纯观点/复盘/情感共鸣），自动选推荐指数最高的。
...
| 情感共鸣 | `"{情感话题} 真实故事 OR 读者投稿 OR 亲身经历"` + `"{情感话题} 心理学 OR 研究 site:zhihu.com OR site:douban.com"` | 真实素材 **+** 真实情感故事/心理学洞察/情感数据（供情感共鸣） |
...
| 检查项 | 标准 | 适用框架 |
|--------|------|---------|
| 增强贯穿 | 增强策略的核心输出（角度/密度/细节/体感/共鸣）在全文可见，不只出现在一段 | 所有 |
...
| 情感共鸣 | 至少 2 个不同场景的情感片段，无空洞鸡汤 | 情感共鸣 |
